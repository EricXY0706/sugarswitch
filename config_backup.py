user_configs = {
    "protein_chain_id": "A",
    "functional_hotspots": [65,61,62,20,16,19,84,88,91,126,15,123,129,12,19], # e.g. [1,2,3,"4-10"]
}
# URIC: [58,160,177,229]
# FTL: [155,156,158,159,161,164,165]
# GH: [1,4,8,116,120,41,45,64,172,175,178], 26
# IL2: [65,61,62,20,16,19,84,88,91,126,15,123,129,12,19]
...
# binder3: ["5-23"]
# binder2: ["5-19"]
# binder_5hcs: [9,10,13,45,58,52,59,88,92,95,99]

pipeline_configs = {
    "Cb_interaction_threshold": 6.0,
    "num_neighbors_to_shield": 3, # NB1: 2
    ...
    "evc_lambda_J": 0.01,
    "evc_num_cpu": 10,
    "conservation_threshold": {"loop": 0.5, "ss": 0.5}, # IL2: (0.83, 0.77), uricase: (0.65, 0.55), NB1: (0.83, 0.45), NB2: (0.8, 0.41), NB3: (0.8, 0.43), binder3: (0.8, 0.7), binder2: (0.63, 0.7)
    "evc_coupling_threshold": 0.5,
    "sasa_cutoff": 0.5, # IL2: 0.65, NB1: 0.4, binder138: 0.3, binder135: 0.6, binder3: 0.6, binder2: 0.65, binder_5hcs: 0.65
