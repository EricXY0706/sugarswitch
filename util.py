...
class BordaCount:
    def __init__(self,
        ...
        self.weights = {
            'Conservation_score': conservation_weight,
            'Coupling_score': coupling_weight,
            'SASA': sasa_weight,
            'SASA_next1': sasa_next1_weight,
            'SASA_next2': sasa_next2_weight,
            'SASA_around_mean': sasa_around_weight,
            'SASA_next_mean': sasa_next_weight,
            "ddG": ddG_weight,
            "dTm": dTm_weight,
            "ddG_S": ddG_S_weight,
            "dTm_S": dTm_S_weight,
            "ddG_T": ddG_T_weight,
            "dTm_T": dTm_T_weight,
            'Mut_score': mut_score_weight,
            'Mut_score_S': mut_score_S_weight,
            'Mut_score_T': mut_score_T_weight,
        }
